...
public class RentalManageController {
    ...
    public String save(@Valid @ModelAttribute RentalManageDto rentalManageDto, BindingResult result,
        ...
        try {
            ...
            Optional<String> vaidErrorEmployeeId = rentalManageService.accountcheck(rentalManageDto.getEmployeeId());
            if (vaidErrorEmployeeId.isPresent()) {
                FieldError fieldError = new FieldError("rentalManageDto", "employeeId", vaidErrorEmployeeId.get());
                result.addError(fieldError);
                throw new Exception("Validetion error");
            }

            Optional<String> vaidErrOptional = rentalManageDto.addError(rentalManageDto.getStatus(),
            ...
            Optional<String> Duplication = rentalManageService.addrentalAble(rentalManageDto.getStockId(),
            ...
            if (Duplication.isPresent()) {
                FieldError fieldError = new FieldError("rentalManageDto", "status", Duplication.get());
                result.addError(fieldError);
                throw new Exception("Validetion error");
            }
    ...
    public String update(@PathVariable("id") String id, @Valid @ModelAttribute RentalManageDto rentalManageDto,
        ...
        try {
            ...
            Optional<String> accountError = rentalManageService.accountcheck(rentalManageDto.getEmployeeId());
            if (accountError.isPresent()) {
                FieldError fieldError = new FieldError("rentalManageDto", "employeeId", accountError.get());
                result.addError(fieldError);
                throw new Exception("Validetion error");
            }

            RentalManage rentalManage = this.rentalManageService.findById(Long.valueOf(id));
            Optional<String> vaidErrOptional = rentalManageDto.isStatusError(rentalManage.getStatus(),
                    rentalManageDto.getStatus(), rentalManageDto.getExpectedRentalOn(),
            ...
            Optional<String> a = rentalManageService.rentalAble(rentalManageDto.getStockId(), rentalManageDto.getId(),
                    new java.sql.Date(rentalManageDto.getExpectedRentalOn().getTime()),
                    new java.sql.Date(rentalManageDto.getExpectedReturnOn().getTime()));
            if (a.isPresent()) {
